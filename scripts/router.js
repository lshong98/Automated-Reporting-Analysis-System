...
//    })
    ...
    .when('/complaint-cmsDailyReport',{
        resolve: {
            "check": function (routingService, $window, $location){
                return routingService.auth($window, $location, '/complaint-cmsDailyReport');
            }
        },
        templateUrl: '/complaint-cmsDailyReport',
        controller: 'complaintcmsDailyReportController',
        controllerAs: 'complaintcmsDailyReport'
    })
    .when('/complaint-cmsSubconData',{
        resolve: {
            "check": function (routingService, $window, $location){
                return routingService.auth($window, $location, '/complaint-cmsSubconData');
            }
        },
        templateUrl: '/complaint-cmsSubconData',
        controller: 'complaintcmsSubconDataController',
        controllerAs: 'complaintcmsSubconDataController'
    })
    .when('/complaint-cmsStatistics',{
        resolve: {
            "check": function (routingService, $window, $location){
                return routingService.auth($window, $location, '/complaint-cmsStatistics');
            }
        },
        templateUrl: '/complaint-cmsStatistics',
        controller: 'complaintscmsStatisticsController',
        controllerAs: 'complaintscmsStatisticsController'
    })
    .when('/complaint-cmsBDStatistics',{
        resolve: {
            "check": function (routingService, $window, $location){
                return routingService.auth($window, $location, '/complaint-cmsBDStatistics');
            }
        },
        templateUrl: '/complaint-cmsBDStatistics',
        controller: 'complaintscmsBDStatisticsController',
        controllerAs: 'complaintscmsBDStatisticsController'
    })
    .when('/complaint-cmsBDQOP',{
        resolve: {
            "check": function (routingService, $window, $location){
                return routingService.auth($window, $location, '/complaint-cmsBDQOP');
            }
        },
        templateUrl: '/complaint-cmsBDQOP',
        controller: 'complaintscmsBDQOPController',
        controllerAs: 'complaintscmsBDQOPController'
    })
