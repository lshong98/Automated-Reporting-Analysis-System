...
function menuItem(keyword, status) {
    switch (keyword) {
        ...
        case "view complaintmodule": 
            if (status == 'A') {
                return '<li class="menu__item" data-ng-show="show.complaintappkch.view == \'A\' || show.complaintwebkch.view == \'A\' || show.complaintlogskch.view == \'A\' || show.complaintappbtu.view == \'A\' || show.complaintwebbtu.view == \'A\' || show.complaintlogsbtu.view == \'A\'" role="menuitem"><a class="menu__link" href="#/complaint-module"><i class="fas fa-bullhorn"></i> CMS (dashboard) <span class="complaint"></span></a></li>';
            }
