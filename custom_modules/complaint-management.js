...
app.get('/getComplaintOfficerList', function (req, res) {
    'use strict';
    var sql = "SELECT tblcomplaintofficer.coID AS 'coID', tblcomplaintofficer.complaintDate AS 'complaintDate', tblcomplaintofficer.name AS 'name', tblcomplaintofficer.company AS 'company', tblcomplaintofficer.step AS 'step', tblcomplaintofficer.services  AS 'services', tblcomplaintofficer.creationDateTime, CONCAT(tblcomplaintofficer.logisticsDate,' - ',tblcomplaintofficer.logisticsTime) AS logisticsDateTime, CONCAT(tblcomplaintofficer.customerDate,' - ',tblcomplaintofficer.customerTime) AS customerDateTime, tblcomplaintofficer.status AS 'status' FROM tblcomplaintofficer ORDER BY tblcomplaintofficer.creationDateTime DESC";
