...
app.post('/getComplaintExportList', function(req, res){
    ...
    if(req.body.services == '0'){
        var sql="SELECT CONCAT(tblcomplaintofficer.complaintDate,' (', DAYNAME(tblcomplaintofficer.complaintDate) ,') ',tblcomplaintofficer.complaintTime) AS 'complaintDate',  tblcomplaintofficer.coID AS 'coID', tblcomplaintofficer.serialNo AS 'serialNo', CONCAT(tblcomplaintofficer.statusDate,' (', DAYNAME(tblcomplaintofficer.statusDate) ,') ',tblcomplaintofficer.statusTime) AS logisticsDateTime, CONCAT(tblcomplaintofficer.customerDate,' (', DAYNAME(tblcomplaintofficer.customerDate) ,') ',tblcomplaintofficer.customerTime) AS customerDateTime, tblcomplaintofficer.bdKPI AS 'bdKPI', tblcomplaintofficer.bdKPIAchieve AS 'bdKPIAchieve', tblcomplaintofficer.lgKPI AS 'lgKPI', tblcomplaintofficer.lgKPIAchieve AS 'lgKPIAchieve', (CASE WHEN tblcomplaintofficer.services = '1' THEN 'Municipal Waste' WHEN tblcomplaintofficer.services = '2' THEN 'Roro Container' WHEN tblcomplaintofficer.services = '3' THEN 'Scheduled Waste' END) AS 'services', tblcomplaintofficer.reason AS 'reason', tblcomplaintofficer.type, tblcomplaintofficer.forwardedSub AS 'forwardedSub', tblcomplaintofficer.name AS 'name', tblcomplaintofficer.sorce AS 'source', tblcomplaintofficer.company AS 'company', tblcomplaintofficer.address AS 'address', tblcomplaintofficer.status AS 'lgStatus', tblcomplaintofficer.custStatus AS 'bdStatus', (CASE WHEN tblcomplaintofficer.cmsStatus = '1' THEN 'Valid' WHEN tblcomplaintofficer.cmsStatus = '2' THEN 'Invalid' WHEN tblcomplaintofficer.cmsStatus = '3' THEN 'To Be Reviewed' END) AS 'cmsStatus', SUBSTRING_INDEX(tblcomplaintofficer.under, ',' , -1) AS 'area', (SELECT tblstaff.staffName FROM tblstaff WHERE staffID = tblcomplaintofficer.driver) AS 'driver', tblcomplaintofficer.remarks AS 'remarks', tblcomplaintofficer.wasteColDT AS 'wasteColDT', (SELECT tblstaff.staffName FROM tblstaff WHERE tblstaff.staffID = tblcomplaintofficer.forwardedBy) AS 'respondent', (SELECT tblstaff.staffName FROM tblstaff WHERE tblstaff.staffID = tblcomplaintofficer.logisticsReview) AS 'logisticsReview', tblcomplaintofficer.zon AS 'zon', (SELECT garbageAmount FROM tblreport WHERE reportID = SUBSTRING_INDEX(tblcomplaintofficer.lgReport, ' ' , -1)) AS 'tonnage' from tblcomplaintofficer WHERE tblcomplaintofficer.zon = '" + req.body.zon + "' AND activeStatus = '1' AND complaintDate BETWEEN '" + req.body.startDate + "' AND '" + req.body.endDate + "' ORDER BY zon DESC, tblcomplaintofficer.complaintDate";
    }
    else{
        var sql="SELECT CONCAT(tblcomplaintofficer.complaintDate,' (', DAYNAME(tblcomplaintofficer.complaintDate) ,') ',tblcomplaintofficer.complaintTime) AS 'complaintDate',  tblcomplaintofficer.coID AS 'coID', tblcomplaintofficer.serialNo AS 'serialNo', CONCAT(tblcomplaintofficer.statusDate,' (', DAYNAME(tblcomplaintofficer.statusDate) ,') ',tblcomplaintofficer.statusTime) AS logisticsDateTime, CONCAT(tblcomplaintofficer.customerDate,' (', DAYNAME(tblcomplaintofficer.customerDate) ,') ',tblcomplaintofficer.customerTime) AS customerDateTime, tblcomplaintofficer.bdKPI AS 'bdKPI', tblcomplaintofficer.bdKPIAchieve AS 'bdKPIAchieve', tblcomplaintofficer.lgKPI AS 'lgKPI', tblcomplaintofficer.lgKPIAchieve AS 'lgKPIAchieve',(CASE WHEN tblcomplaintofficer.services = '1' THEN 'Municipal Waste' WHEN tblcomplaintofficer.services = '2' THEN 'Roro Container' WHEN tblcomplaintofficer.services = '3' THEN 'Scheduled Waste' END) AS 'services', tblcomplaintofficer.type, tblcomplaintofficer.forwardedSub AS 'forwardedSub', tblcomplaintofficer.name AS 'name', tblcomplaintofficer.sorce AS 'source', tblcomplaintofficer.company AS 'company', tblcomplaintofficer.address AS 'address', tblcomplaintofficer.status AS 'lgStatus', tblcomplaintofficer.custStatus AS 'bdStatus', (CASE WHEN tblcomplaintofficer.cmsStatus = '1' THEN 'Valid' WHEN tblcomplaintofficer.cmsStatus = '2' THEN 'Invalid' WHEN tblcomplaintofficer.cmsStatus = '3' THEN 'To Be Reviewed' END) AS 'cmsStatus', SUBSTRING_INDEX(tblcomplaintofficer.under, ',' , -1) AS 'area', (SELECT tblstaff.staffName FROM tblstaff WHERE staffID = tblcomplaintofficer.driver) AS 'driver', tblcomplaintofficer.remarks AS 'remarks', tblcomplaintofficer.wasteColDT AS 'wasteColDT', (SELECT tblstaff.staffName FROM tblstaff WHERE tblstaff.staffID = tblcomplaintofficer.forwardedBy) AS 'respondent', (SELECT tblstaff.staffName FROM tblstaff WHERE tblstaff.staffID = tblcomplaintofficer.logisticsReview) AS 'logisticsReview', tblcomplaintofficer.zon AS 'zon', (SELECT garbageAmount FROM tblreport WHERE reportID = SUBSTRING_INDEX(tblcomplaintofficer.lgReport, ' ' , -1)) AS 'tonnage' from tblcomplaintofficer WHERE tblcomplaintofficer.services = '" + req.body.services + "' AND tblcomplaintofficer.zon = '" + req.body.zon + "' AND activeStatus = '1' AND complaintDate BETWEEN '" + req.body.startDate + "' AND '" + req.body.endDate + "' ORDER BY zon DESC, tblcomplaintofficer.complaintDate";
    }
    database.query(sql, function(err, result){
        if(err){
            throw err;
...
app.post('/getCmsDatasheet', function(req ,res){
    ...
    var sql= "SELECT tblcomplaintofficer.coID AS 'coID', tblcomplaintofficer.serialNo AS 'serialNo', tblcomplaintofficer.complaintDate AS 'complaintDate', tblcomplaintofficer.complaintTime AS 'complaintTime', tblcomplaintofficer.customerDate AS 'customerDate', tblcomplaintofficer.customerTime AS 'customerTime', tblcomplaintofficer.services AS 'services', tblcomplaintofficer.under AS 'area', tblcomplaintofficer.forwardedSub AS 'subcon', tblcomplaintofficer.name AS 'name', tblcomplaintofficer.telNo AS 'contact', tblcomplaintofficer.company AS 'company', tblcomplaintofficer.address AS 'address', tblcomplaintofficer.type AS 'type', tblcomplaintofficer.remarks AS 'remarks', tblcomplaintofficer.wasteColDT AS 'wasteColDT', tblstaff.staffName AS 'driver', tblcomplaintofficer.typeCode AS 'typeCode', (CASE WHEN tblcomplaintofficer.cmsStatus = '1' THEN 'Valid' WHEN tblcomplaintofficer.cmsStatus = '2' THEN 'Invalid' WHEN tblcomplaintofficer.cmsStatus = '3' THEN 'To Be Reviewed' END) AS 'cmsStatus' FROM tblcomplaintofficer LEFT JOIN tblstaff ON tblcomplaintofficer.driver = tblstaff.staffID WHERE tblcomplaintofficer.activeStatus = '1' AND tblcomplaintofficer.zon = '" + req.body.zon + "' AND tblcomplaintofficer.services = '" + req.body.services + "' AND tblcomplaintofficer.complaintDate BETWEEN '" + req.body.startDate + "' AND '" + req.body.endDate + "'  ORDER BY complaintDate DESC";
