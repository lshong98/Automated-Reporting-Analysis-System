...
emitter.on('createTable', function () {
    ...
    sqls = [
        ...
        "CREATE TABLE tblbinrequest(reqID int auto_increment, userID varchar(15), dateRequest datetime, name varchar(15), companyName varchar(30), companyAddress varchar(100), contactNumber varchar(15), reason varchar(20), type varchar(20), requestAddress varchar(100), remarks varchar(300), icImg varchar(200), utilityImg varchar(200), assessmentImg varchar(200), tradingImg varchar(200), policeImg varchar(200), binImg varchar(200), status varchar(20), council varchar(15), acrSticker varchar(50), acrfNumber varchar(50), jobDesc varchar(50), binDelivered mediumtext, binPulled mediumText, binSize varchar(50), unit varchar(50), readStat varchar(1), PRIMARY KEY(reqID), FOREIGN KEY(userID) REFERENCES tbluser(userID))",
        "CREATE TABLE tblsatisfaction_municipal (satisfactionMunicipalID int(11) auto_increment, userID varchar(15), name varchar(200), company varchar(200), address mediumtext, number varhcar(13), companyRating char(1), teamEfficiency char(1), collectionPromptness char(1), binHandling char(1), spillageControl char(1), queryResponse char(1), extraComment varchar(300), submissionDate datetime, readStat varchar(1), PRIMARY KEY(satisfactionMunicipalID))",
        "CREATE TABLE tblsatisfaction_commercial (satisfactionCommercialID int(11) auto_increment, userID varchar(15), name varchar(200), company varchar(200), address mediumtext, number varhcar(13), companyRating char(1), teamEfficiency char(1), collectionPromptness char(1), cleanliness char(1), physicalCondition char(1), queryResponse char(1), extraComment varchar(300), submissionDate datetime, readStat varchar(1), PRIMARY KEY(satisfactionCommercialID))",
        "CREATE TABLE tblsatisfaction_scheduled ( satisfactionScheduledID int(11) auto_increment, userID varchar(15), name varchar(200), company varchar(200), address mediumtext, number varhcar(13), companyRating char(1), teamEfficiency char(1), healthAdherence char(1), regulationsAdherence char(1), queryResponse char(1), extraComment varchar(300), submissionDate datetime, readStat varchar(1), PRIMARY KEY(satisfactionScheduledID))",
