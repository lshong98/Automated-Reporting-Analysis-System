...
emitter.on('createTable', function () {
    ...
    sqls = [
        ...
        "CREATE TABLE tblchat (chatID VARCHAR(300) PRIMARY KEY, sender VARCHAR(15), recipient VARCHAR(15), content MEDIUMTEXT, complaintID VARCHAR(25), creationDateTime DATETIME, status CHAR(1), readStat varchar(1), FOREIGN KEY(complaintID) REFERENCES tblcomplaint(complaintID))",
