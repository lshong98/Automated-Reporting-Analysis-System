...
var DB_NAME = process.env.DATABASE_NAME || 'trienekens2'; 
...
emitter.on('createTable', function () {
    ...
    sqls = [
        ...
        "CREATE TABLE tblsatisfaction(satisfactionID int auto_increment, userID varchar(15), companyRating varchar(7), teamEfficiency varchar(7), collectionPromptness varchar(7), binHandling varchar(7), spillageControl varchar(7), queryResponse varchar(7), extraComment varchar(7), submissionDate datetime, readStat varchar(1), PRIMARY KEY (satisfactionID), FOREIGN KEY (userID) REFERENCES tbluser(userID))",
