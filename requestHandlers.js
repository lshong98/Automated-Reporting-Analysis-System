...
app.get('/bdb-hist-detail/:bdbID', function (req, res) {
    'use strict';
    res.sendFile('pages/bdb-hist-detail.html', {root: __dirname});
});
...
app.get('/acr-database-edit/:acrID', function(req,res){
    'use strict';
    res.sendFile('pages/acr-database-edit.html', {root: __dirname});
})
app.get('/acr-database-custList', function(req,res){
    'use strict';
...
app.get('/complaint-cmsBDQOP',function (req, res){
    'use strict';
    res.sendFile('pages/complaint-cmsBDQOP.html', {root: __dirname});
});
...
app.get('/bin-stock', function (req, res) {
    'use strict';
    res.sendFile('pages/bin-stock.html', {root: __dirname});
});
